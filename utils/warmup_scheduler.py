"""Copied from: https://github.com/LEFTeyex/warmup/blob/master/src/warmup_scheduler_pytorch/warmup_module.py"""
...
class WarmUpScheduler(_LRScheduler):
    ...
    def get_warmup_lr(self):
        ...
        if self.warmup_mode == "linear":
            ...
            raise ValueError(f"Now the other warmup_mode is not implemented, " f"there is only 'linear' mode")
